...
This project is a 3D physics simulation implemented by XPBD method using the Vulkan API. To optimize storage space and portability, the Vulkan SDK is not included, and the local SDK is referenced via environment variables.
